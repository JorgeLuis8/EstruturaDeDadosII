    ...
    do {
        ...
        switch(opcao) {
            case 1:
                ...
                // Abrir o arquivo para salvar os tempos
                arquivo = fopen("tempos_cesar.txt", "w");
                if (arquivo == NULL) {
                ...
                for (int t = 0; t < NUM_TESTES; t++) {
                    ...
                    // Salvar o tempo de cada teste no arquivo
                    fprintf(arquivo, "Teste %d: %.6f segundos\n", t + 1, tempos[t]);
                }

                // Calcular e salvar a média no arquivo
                fprintf(arquivo, "Tempo médio: %.6f segundos\n", calcularMedia(tempos, NUM_TESTES));

                // Fechar o arquivo
                fclose(arquivo);

                printf("Tempos salvos no arquivo 'tempos_cesar.txt'.\n");
                break;
            ...
            case 2:
                ...
                // Abrir o arquivo para salvar os tempos
                arquivo = fopen("tempos_vigenere.txt", "w");
                if (arquivo == NULL) {
                    printf("Erro ao abrir o arquivo!\n");
                    return 1;
                }
                ...
                printf("Tempos salvos no arquivo 'tempos_vigenere.txt'.\n");
                break;
